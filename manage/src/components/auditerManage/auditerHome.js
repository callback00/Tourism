...
class AuditerHome extends React.Component {
    ...
    showAreaModalHandle(option) {
        if (this.state.selectTreeKey === '') {
            ...
            const modalAreaKey = this.state.modalAreaKey + 1;
            this.setState({
    ...
    showAuditerModalHandle(option, id) {
        if (this.state.selectTreeKey === '') {
            ...
            const modalAuditKey = this.state.modalAuditKey + 1;
            this.setState({
        ...
        return (
            <div className="auditer-manage-wrapper">
                ...
                <WorkAreaModal
                    ...
                    key={'area' + this.state.modalAreaKey}
                    modalKey={this.state.modalAreaKey}
                ...
                <WorkAreaAuditerModal
                    ...
                    option={this.state.option}
                    key={'auditer' + this.state.modalAuditKey}
                    modalKey={this.state.modalAuditKey}
